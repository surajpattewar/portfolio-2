...
import { FaDatabase, FaTerminal, FaRobot } from "react-icons/fa6";
import {
  SiPython,
  SiApachespark,
  SiGooglecloud,
  ...
  const techCategories: TechCategory[] = [
    ...
    },
    {
      ...
      technologies: [
        ...
        { name: "ClickHouse & DuckDB", Icon: FaDatabase },
    ...
    },
    {
      ...
      technologies: [
        { name: "Agentic AI & LLMs", Icon: FaRobot },
        { name: "Streamlit", Icon: SiStreamlit },
        { name: "Playwright (Scraping)", Icon: PlaywrightIcon },
      ],
    },
    {

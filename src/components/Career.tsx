      ...
      <div className="career-container">
        ...
        <div className="career-info">
          ...
          <div className="career-info-box">
            ...
            <p>
              Architecting FastAPI-based microservices and AI Agent workflows for tender intelligence and automated scraping, saving 50–60 hours of manual effort weekly. Lead PySpark to DuckDB/ClickHouse migrations (saved 78% in costs), optimized Spark streaming, and deployed Kafka MirrorMaker on Kubernetes.
            </p>
          </div>
          <div className="career-info-box">
            <div className="career-info-in">
